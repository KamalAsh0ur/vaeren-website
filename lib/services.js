export const services = {
  ...
  'something-else': {
    ...
    positioning: "Bring us the problem. We'll figure out what it needs.",
    positioningDescription: "We throw out the standard playbook and start with first principles to solve unconventional problems.",
    capabilities: [
      'CUSTOM PROJECTS',
