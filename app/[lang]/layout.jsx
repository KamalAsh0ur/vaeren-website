import { Cormorant_Garamond, Outfit, Noto_Kufi_Arabic } from 'next/font/google';
...
export default async function RootLayout({ children, params }) {
  ...
  return (
    <html lang={lang} dir={dir} className={`${fontDisplay.variable} ${fontSystem.variable} ${fontArabic.variable} antialiased scroll-smooth`}>
      <body suppressHydrationWarning className="bg-[var(--color-vaeren-void)] text-[var(--color-vaeren-bone)] selection:bg-[var(--color-vaeren-concrete)] selection:text-[var(--color-vaeren-void)] cursor-none">
        ...
        <Script id="meta-pixel" strategy="afterInteractive">
          {`
            ...
            fbq('init', '1762585868316313');
            fbq('track', 'PageView');
          `}
        </Script>
        <noscript>
          <img height="1" width="1" style={{ display: 'none' }} src="https://www.facebook.com/tr?id=1762585868316313&ev=PageView&noscript=1" alt="" />
        </noscript>
        <script
